...
void InitializePIDs()
{
   ...
   oPID_Angle.SetKi( &oPID_Angle.Parameters, 2.45f );
   oPID_Angle.SetKd( &oPID_Angle.Parameters, 100.0f );
   ...
   oPID_Omega.SetKi( &oPID_Omega.Parameters, 0.004f );
   oPID_Omega.SetKd( &oPID_Omega.Parameters, 0.004f );
